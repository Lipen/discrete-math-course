...
The parentheses in $(f(x))$ mark the ideal generated by $f$: the set of all multiples of $f$, so two polynomials end up in the same class exactly when they differ by such a multiple.
