...
#example[
  ...
  #align(center)[
    ...
    #grid(
      ...
      diagram(
        ...
        edge-stroke: 1pt,
        vertex((0, 0.5), $u$, <u>, blue),
        vertex((1, 0), $a$, <a>, orange),
        vertex((1, 1), $b$, <b>, orange),
        vertex((2, 0), $c$, <c>, blue),
        vertex((2, 1), $d$, <d>, blue),
        vertex((3, 0.5), $v$, <v>, blue),
        edge(<u>, <a>, stroke: gray),
        edge(<a>, <c>, stroke: gray),
        edge(<c>, <v>, stroke: gray),
        edge(<u>, <b>, stroke: gray),
        edge(<b>, <d>, stroke: gray),
        edge(<d>, <v>, stroke: gray),
        edge(<a>, <d>, stroke: gray),
        edge(<b>, <c>, stroke: gray),
        edge(<c>, <d>, stroke: gray),
      ),
  ...
  Path 1 (#Green[$u$-$a$-$c$-$v$]) and Path 2 (#Blue[$u$-$b$-$d$-$v$]) are _internally vertex-disjoint_.

  Deleting the orange vertices $a$ and $b$ disconnects $u$ from $v$, so a _minimum vertex separator_ has size 2.
]
