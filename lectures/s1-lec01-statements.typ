...
- Например, "не ($A$ и $B$)" эквивалентно "(не $A$) или (не $B$)".
...
#definition[Интерпретация][
  *Интерпретация* --- функция $nu: V -> {0, 1}$, приписывающая истинностное значение каждой переменной формулы.
...
#definition[Распространение интерпретации][
...
#note[
  Эквивалентность $iff$ --- сокращение: $alpha iff beta equiv (alpha imply beta) and (beta imply alpha)$.
]
...
#example[
  Рассуждение по схеме *modus ponens*: $P imply Q, P models Q$. \
...
$
  ...
  & equiv (not P or P) or not Q & quad & "коммутативность и ассоциативность" \
...
#important[
  ...
  - Эквивалентность $equiv$ --- инструмент переписывания.
    Законы логики высказываний и де Морган --- рабочие.
...
+ Упростите $not (P or Q) or P$ законами логики высказываний: тавтология, противоречие или ни то, ни другое?
