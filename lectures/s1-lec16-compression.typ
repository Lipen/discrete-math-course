...
#definition[Тройка LZ77][
  Кодер ищет совпадения в _скользящем окне_ --- уже закодированном хвосте входа.
  Повтор кодируется тройкой $(o, l, a)$: смещение назад, длина совпадения, первый несовпавший символ.
]

LZ78 копит _словарь фраз_ вместо окна: выход --- пары из номера фразы и нового символа.
...
+ Сожмите "ABRACADABRA" тройками LZ77 с окном в весь уже закодированный префикс.
  Какая тройка кодирует финальное "ABRA"?
