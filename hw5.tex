...
\begin{tasks}
    ...
    \begin{subtasks}
        \item \tikz[mygraphstyle, baseline=(b.south)]{
            ...
            \node[dot] (a) [label=above right:{a}, above left=8mm and 16mm of b] {};
            \node[dot] (c) [label=above right:{c}, above right=8mm and 16mm of b] {};
            \node[dot] (e) [label=below right:{e}, below left=8mm and 16mm of b] {};
            \node[dot] (d) [label=below right:{d}, below right=8mm and 16mm of b] {};
            \draw (a) -- (b) -- (c) -- (d) -- (b) -- (e) -- (a);
        }
        ...
        \item \tikz[mygraphstyle, baseline=(c.south)]{
            ...
            \node[dot] (k) [label=below:{$k$}, below=8mm of h] {};
            ...
            \node[dot] (m) [label=below:{$i$}, below=8mm of i] {};
            \draw (a) -- (d) -- (h) -- (k) -- (g) -- (c) -- (a);
            \draw (b) -- (e) -- (i) -- (m) -- (j) -- (f) -- (b);
            \draw (a) -- (b);
            \draw (k) -- (m);
        ...
        \item \tikz[mygraphstyle, baseline=(b.south)]{
            ...
            \node[dot] (d) [label=below left:{\smash{$d$}}, position=210:14mm from zero] {};
            \node[dot] (f) [label=below right:{\smash{$f$}}, position=-30:14mm from zero] {};
            \node[dot] (b) [label=above left:{\smash{$b$}}, position=150:{7mm-1pt} from zero] {};
            \node[dot] (c) [label=above right:{\smash{$c$}}, position=30:{7mm-1pt} from zero] {};
    ...
    \tikz[mygraphstyle] {
        ...
        \node[dot] (o) [label=above left:{$o$}, right=36mm of h] {};
