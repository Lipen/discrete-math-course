...
\begin{terms}
    ...
    %     \verb/./ & Any single character from the alphabet \\
    %     \verb/[abc]/ & Any single character from the group (i.e.\ \verb/a/, \verb/b/, or \verb/c/) \\
    %     \verb/[a-z]/ & Any single character from the range (i.e.\ any lowercase letter from \verb/a/ to \verb/z/) \\
    %     \verb/[^abc]/ & Any single character \textbf{not} from the group \\
    %     $\alpha | \beta$ & \ or $b$ \\
    %     $^ a$ & Starts with a \\
    %     $a\$$ & Ends with a \\
    %     $a?$ & 0 or 1 times \\
