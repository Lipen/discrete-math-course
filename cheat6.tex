...
\begin{terms}
    ...
    \begin{wrapfigure}{r}{0pt}
        \tikz[myautomatonstyle]{
            ...
            ;
            \node at (5.5,0) [align=left] {The output of this Mealy \\ machine is \enquote{y} whenever \\ the last two symbols \\ in the input are the same, \\ and \enquote{n} if they are different.};
        }
        \vspace{-\intextsep}
    \end{wrapfigure}
