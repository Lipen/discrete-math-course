...
//! -- half/full, ripple-carry, and carry-lookahead -- verifying every one
//! against ordinary integer addition.
//!
//! ```
...
pub use adder::{
    bits_of, carry_lookahead_adder, full_adder, half_adder, ripple_carry_adder, value_of, Adder,
};
