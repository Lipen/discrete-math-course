...
#align(center, box(width: 5cm, height: 3.6cm)[#place(center + horizon, scale(
  chomsky-hierarchy,
  x: 90%,
  y: 90%,
))])
...
#note[
  ...
  - *Контекстно-зависимые*: машины с линейной памятью.
  - *Рекурсивно перечислимые*: машины Тьюринга.
]

#important[
  Каждая ступень --- строго больше предыдущей.

  $a^n b^n$ --- КС, но не регулярная.
]
