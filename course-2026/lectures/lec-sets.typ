...
== Мост
Множества дали логике конкретный домен, а логика множествам --- аппарат доказательств.
Дальше по курсу множества используются повсюду.

#Block(color: yellow)[
  Бинарные отношения --- множества пар.
  Функции --- частный случай отношений.
  Порядки --- отношения с особыми свойствами.
]
