...
Математическое рассуждение должно быть точным и проверяемым.

Обычный язык двусмыслен; логика --- точный язык рассуждений.
...
#Block(color: colors.amber)[
  К концу лекции вы решите её формально.
]
...
"Не (A и B)" равносильно "(не A) или (не B)" --- зачаток де Моргана.
...
Доказательство --- цепочка логических шагов: каждый шаг опирается на определения, аксиомы или ранее доказанные факты.
