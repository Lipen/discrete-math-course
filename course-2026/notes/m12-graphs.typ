...
#align(center)[
  ...
  В главе M13 «Конечные автоматы» мы изучим простейшую модель вычислений: deterministic finite automata (DFA), недетерминизм, регулярные языки и их связь с регулярными выражениями --- фундамент теории компиляторов и обработки текста.
  #v(0.4em)
  #line(length: 30%, stroke: 1pt + luma(80%))
]
