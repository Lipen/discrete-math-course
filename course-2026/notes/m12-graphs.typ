...
#figure(
  ...
  caption: [Граф Петерсена: 3-регулярный, 10 вершин, не планарный, вершинно-транзитивный.
    Классический контрпример ко многим утверждениям в теории графов.],
) <fig:petersen>
...
#figure(
  ...
  caption: [Неориентированный граф с 6 вершинами и 9 рёбрами.
    Сумма степеней: $3+4+3+2+4+2 = 18 = 2 dot 9$.],
) <fig:simple-graph>
...
#remark[Разработка компиляторов][
  ...
  Задача распределения регистров сводится к раскраске этого графа:有多少 доступных регистров, столько цветов.
]
