...
#align(center)[
  ...
  В главе M05 «Отношения порядка» мы углубимся в частичные порядки: диаграммы Хассе, экстремальные элементы, решётки и топологическую сортировку --- инструменты, моделирующие зависимости и иерархии во всех языках программирования.
  #v(0.4em)
  #line(length: 30%, stroke: 1pt + luma(80%))
]
