...
#proposition[Cardinality classification][
  #table(
columns: 4, align: (center, center, center, left), stroke: (x, y) => if y == 0 { (bottom: 0.4pt) }, table.header([*Type*], [*Condition*], [*Cardinality*], [*Inverse*]), [Injection], [$f(a_1) = f(a_2) arrow a_1 = a_2$], [$|A| <= |B|$], [Left inverse $g @ f = "id"_A$],

[Surjection], [$forall b exists a: f(a) = b$], [$|A| >= |B|$], [Right inverse $f @ g = "id"_B$],

[Bijection], [Injective + surjective], [$|A| = |B|$], [Two-sided inverse $f^(-1)$], ) ]
