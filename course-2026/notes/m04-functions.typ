...
Наглядная геометрическая интерпретация трёх типов отображений: точки слева --- элементы области определения, точки справа --- элементы кообласти, стрелки --- действие функции.
