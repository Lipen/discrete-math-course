...
#let mapping-injection = canvas({
  ...
  lbl((-2, 1.4), $A$)
  draw.circle((-2, -0.65), radius: 0.07, fill: c-dot, name: "a1")
  draw.circle((-2, -0.25), radius: 0.07, fill: c-dot, name: "a2")
  draw.circle((-2, 0.15), radius: 0.07, fill: c-dot, name: "a3")
  draw.circle((-2, 0.55), radius: 0.07, fill: c-dot, name: "a4")

  draw.circle((2, 0), radius: (0.55, 1.4), fill: c-cod, stroke: c-str)
  lbl((2, 1.7), $B$)
  draw.circle((2, -1.05), radius: 0.07, fill: c-dot, name: "b1")
  draw.circle((2, -0.65), radius: 0.07, fill: c-dot, name: "b2")
  draw.circle((2, -0.25), radius: 0.07, fill: c-dot, name: "b3")
  draw.circle((2, 0.15), radius: 0.07, fill: c-dot, name: "b4")
  draw.circle((2, 0.55), radius: 0.07, fill: c-dot, name: "b5")
  draw.circle((2, 0.95), radius: 0.07, fill: c-dot, name: "b6")
  ...
  lbl((0, -2.2), text(weight: "bold")[Инъекция])
})
...
#let mapping-surjection = canvas({
  ...
  lbl((-2, 1.7), $A$)
  draw.circle((-2, -1.05), radius: 0.07, fill: c-dot, name: "a1")
  draw.circle((-2, -0.65), radius: 0.07, fill: c-dot, name: "a2")
  draw.circle((-2, -0.25), radius: 0.07, fill: c-dot, name: "a3")
  draw.circle((-2, 0.15), radius: 0.07, fill: c-dot, name: "a4")
  draw.circle((-2, 0.55), radius: 0.07, fill: c-dot, name: "a5")
  draw.circle((-2, 0.95), radius: 0.07, fill: c-dot, name: "a6")

  draw.circle((2, 0), radius: (0.55, 0.9), fill: c-cod, stroke: c-str)
  lbl((2, 1.2), $B$)
  draw.circle((2, -0.45), radius: 0.07, fill: c-dot, name: "b1")
  draw.circle((2, 0), radius: 0.07, fill: c-dot, name: "b2")
  draw.circle((2, 0.45), radius: 0.07, fill: c-dot, name: "b3")
  ...
  lbl((0, -2.2), text(weight: "bold")[Сюръекция])
})
...
#let mapping-bijection = canvas({
  ...
  lbl((2, 1.4), $B$)
  draw.circle((2, -0.65), radius: 0.07, fill: c-dot, name: "b1")
  draw.circle((2, -0.25), radius: 0.07, fill: c-dot, name: "b2")
  draw.circle((2, 0.15), radius: 0.07, fill: c-dot, name: "b3")
  draw.circle((2, 0.55), radius: 0.07, fill: c-dot, name: "b4")

  draw.line("a1", "b3", stroke: c-str, mark: (end: (symbol: ">", fill: black)))
  draw.line("a2", "b1", stroke: c-str, mark: (end: (symbol: ">", fill: black)))
  draw.line("a3", "b4", stroke: c-str, mark: (end: (symbol: ">", fill: black)))
  draw.line("a4", "b2", stroke: c-str, mark: (end: (symbol: ">", fill: black)))
  lbl((0, -2.2), text(weight: "bold")[Биекция])
})
