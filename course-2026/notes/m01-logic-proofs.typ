...
Формализация рассуждений --- идея, прошедшая путь от античности до XX века, прежде чем стать работающим инструментом.
Исторические детали собраны в справке ниже; здесь мы сосредоточимся на самих инструментах и на том, как их применять.
