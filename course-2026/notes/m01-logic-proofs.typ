...
#note[Функциональная полнота][
  ...
  «И», «или», «если... то» --- это не формальные конструкции, придуманные математиками, а базовые операции человеческого мышления.
  Логика их формализует, а не изобретает.
...
Именно поэтому структурная индукция --- основной инструмент в теории формальных языков, теории типов и верификации программ.
Всякий раз, когда доказывается свойство для всех программ на некотором языке, неявно используется структурная индукция по абстрактному синтаксическому дереву.
...
#note[Ключевая идея: арсенал доказательств][
  Индукция, контрапозиция и доказательство от противного покрывают более 90% всех доказательств в дискретной математике.
