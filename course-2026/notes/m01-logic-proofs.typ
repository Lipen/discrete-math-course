...
#align(center)[
  ...
  В главе M02 «Множества» мы формализуем коллекции, операции над ними и установим связь теории множеств с SQL, битовыми масками и типами в языках программирования.
  #v(0.4em)
  #line(length: 30%, stroke: 1pt + luma(80%))
]
