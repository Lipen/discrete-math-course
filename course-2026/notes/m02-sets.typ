...
#align(center)[
  ...
  В главе M03 «Отношения» мы изучим бинарные отношения --- формализацию связей между элементами, --- их алгебраические свойства, и два важнейших частных случая: отношения эквивалентности и частичные порядки.
  #v(0.4em)
  #line(length: 30%, stroke: 1pt + luma(80%))
]
