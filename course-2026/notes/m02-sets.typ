...
Он доказал несчётность действительных чисел и ввёл понятие мощности.
Его работы встретили сопротивление --- Леопольд Кронекер резко критиковал новый подход, --- но к началу XX века теория множеств стала фундаментом математики.
...
Каждый объект в этом курсе --- граф, автомат, функция, отношение --- определяется как множество специального вида.
...
Типы в языках программирования --- это множества.
