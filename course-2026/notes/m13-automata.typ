...
#figure(
dfa-01, caption: [DFA recognising strings over ${0, 1}$ ending with $"01"$.
Accepting state $q_2$ has a double border.], ) <fig:dfa-01>
...
#figure(
nfa-00-11, caption: [NFA recognising strings over ${0, 1}$ containing $"00"$ or $"11"$.
Two independent branches guess the pattern.], ) <fig:nfa-00-11>
...
#proposition[DFA vs NFA --- comparison][
  #table(
columns: 3, align: (left, left, left), stroke: (x, y) => if y == 0 { (bottom: 0.4pt) }, table.header([*Property*], [*DFA*], [*NFA*]), [Transition], [$delta(q, a)$ = single state], [$delta(q, a)$ = set of states],

[$epsilon$-transitions], [Not allowed], [Allowed (spontaneous)], [States required], [Potentially exponential], [Often linear / polynomial], [Acceptance], [Unique computation path], [Some path leads to accept], [Implementation], [Table-driven, simple loop], [Backtracking or subset simulation],
