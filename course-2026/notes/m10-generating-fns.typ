...
#proposition[Standard OGFs][
  #table(
columns: 2, align: (left, left), stroke: (x, y) => if y == 0 { (bottom: 0.4pt) }, table.header([*Sequence* $a_n$], [*OGF* $A(x)$]), [$a_n = 1$], [$1/(1-x)$], [$a_n = n$], [$x/(1-x)^2$], [$a_n = binom(k, n)$], [$(1+x)^k$], [$a_n = binom(n+k-1, n)$], [$1/(1-x)^k$], [$a_n = c^n$], [$1/(1 - c x)$], ) ]
...
#proposition[Standard EGFs][
  #table(
columns: 2, align: (left, left), stroke: (x, y) => if y == 0 { (bottom: 0.4pt) }, table.header([*Sequence* $a_n$], [*EGF* $E(x)$]), [$a_n = 1$], [$e^x$], [$a_n = n!$], [$1/(1-x)$], [$a_n = c^n$], [$e^(c x)$], [$a_n = S(n, k)$], [$(e^x - 1)^k/(k!)$], [$a_n = B_n$ (Bell)], [$e^(e^x - 1)$], ) ]
