...
#proposition[Complexity class landscape][
  #table(
columns: 4, align: (left, left, left, left), stroke: (x, y) => if y == 0 { (bottom: 0.4pt) }, table.header( [*Class*], [*Resource bound*], [*Canonical problem*], [*Status*] ), [P], [Polynomial time], [Shortest path, sorting, MST], [Tractable], [NP], [Nondeterministic poly-time], [SAT, TSP, Clique], [Open: $P = "NP"$?], [coNP], [Complement of NP], [UNSAT, tautology], [Open: $"NP" = "coNP"$?], [PSPACE], [Polynomial space], [QBF, geography, chess], [$"NP" subset.eq "PSPACE"$],

[EXP], [Exponential time], [Generalised chess, Go], [$"PSPACE" subset "EXP"$],

[\#P], [Counting solutions], [\#SAT, counting matchings], [Harder than NP], [BQP], [Quantum poly-time], [Factoring (Shor)], [$P subset.eq "BQP" subset.eq "PSPACE"$], ) ]
