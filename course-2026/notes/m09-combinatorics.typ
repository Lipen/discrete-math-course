...
#proposition[Four counting situations][
  #table(
columns: 3, align: (center, center, left), stroke: (x, y) => if y == 0 { (bottom: 0.4pt) }, table.header([*Balls*], [*Boxes*], [*Count*]), [Distinct], [Distinct], [$k^n$ --- each ball chooses a box], [Identical], [Distinct], [$binom(n+k-1, n)$ --- stars and bars], [Distinct], [Identical], [$S(n,1) + ... + S(n,k)$ --- Stirling 2nd kind], [Identical], [Identical], [Integer partitions], ) ]
