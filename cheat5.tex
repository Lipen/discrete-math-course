...
\begin{terms}
    ...
    \item \textbf{Spanning subgraph} of a subgraph that includes all vertices of a graph.
    ...
    \begin{terms}
        ...
        \tikz[baseline]{
            ...
            \node[dot] (1) [label={1}, position=-160:{\Dist} from 5] {};
            \node[dot] (4) [label={4}, position=130:{\Dist} from 5] {};
            \draw (1) -- (5);
            \draw (4) -- (5);
            \draw (5) -- (2);
            \draw (2) -- (7);
        ...
        \tikz[baseline]{
            ...
            \node[dot,red] (1) [label={[text=red]1}, position=-160:{\Dist} from 5] {};
            \node[dot] (4) [label={4}, position=130:{\Dist} from 5] {};
            \draw[red] (1) -- (5);
            \draw (4) -- (5);
            \draw (5) -- (2);
        ...
        \tikz[baseline]{
            ...
            \node[dot] (6) [label={6}, position=-60:{\Dist} from 3] {};
            \node[dot,blue] (5) [label={[text=blue]5}, position=-120:{\Dist} from 2] {};
            \node[dot,lightgray] (1) [label={[text=lightgray]1}, position=-160:{\Dist} from 5] {};
            \node[dot,red] (4) [label={[text=red]4}, position=130:{\Dist} from 5] {};
        ...
        \tikz[baseline]{
            ...
            \node[dot,lightgray] (1) [label={[text=lightgray]1}, position=-160:{\Dist} from 5] {};
            \node[dot,lightgray] (4) [label={[text=lightgray]4}, position=130:{\Dist} from 5] {};
            \draw[lightgray,dashed] (1) -- (5);
        ...
        % P: deque = Prüfer code
        % W: deque = {v| v not in Prüfer code}
        % while P is not empty:
        %     v = P.pop_left()
        %     edge_connect(W.pop_min(), v)
        %     If v not in P:
        %         W.add(v)
        % edge_connect(W[0], W[1])
