...
\begin{terms}
    ...
    \begin{wrapfigure}{r}{0pt}
        ...
        \begin{adjustbox}{tabular={@{} ccc @{}}}
            \tikz[baseline=(label.base)]{
                ...
                ;
                \node[below] (label) at (current bounding box.south) {Simple};
            } &
            \tikz[baseline=(label.base)]{
                \path
                    (0,.1)   node[dot] (a) {}
                ...
                ;
                \node[below] (label) at (current bounding box.south) {Multigraph};
            } &
            \tikz[baseline=(label.base)]{
                \path
                    (0,.1)   node[dot] (a) {}
                ...
                ;
                \node[below] (label) at (current bounding box.south) {Pseudograph};
            } \\[4pt]
            ...
            \tikz[baseline=(label.base)]{
                \path
                    ...
                    (.7,.2)  node[dot] (d) {}
                ;
                \node[below] (label) at (current bounding box.south) {Empty};
            } &
            \tikz[baseline=(label.base)]{
                \path
                    (0,0)    node[dot] (a) {}
                ...
                \draw
                    ...
                    (c) edge (d)
                ;
                \node[below] (label) at (current bounding box.south) {Complete};
            }
        \end{adjustbox}
        \vspace{-\intextsep}
    \end{wrapfigure}
    ...
    \item \textbf{$k$-edge-connected graph}\Href{https://en.wikipedia.org/wiki/K-edge-connected_graph} is a graph remains connected after less than $k$ edges are removed, \ie $\edgeConnectivity{G} \geq k$.
    \begin{items}
