...
|image:https://img.shields.io/badge/Lecture-Pumping Lemma-blue?style=social&logo=gitbook["Lecture: Pumping Lemma", link="https://lipen.github.io/discrete-math-course/lec-pumping.pdf"]
|===
